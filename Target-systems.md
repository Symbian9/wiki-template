...
--------------|-------------|-------------|-------------|----------------|-------------|-------------|-------------
[Android](Android)        | 3.7    | gcc 4.9 :-1: | 5.6.2  | 6.1.3a | 4.9.3  | 2.1.2  | local superbuild
[Arch Linux](#arch-linux) | 3.9.1  | gcc 7.1.1  | 5.9.1  | 6.4.2 | 4.9.3  | 2.2.1  | OBS, [AUR](#arch-linux)
Debian 8.0                | 3.0.2 :-1: | gcc 4.9.2 :-1: | 5.3.2 :-1: | 6.1.3a | 4.8.0  | 1.10.1 :-1: | OBS
...
macOS (aka OS X)          | 3.x    | XCode 7.0  | 5.6.2  | 6.1.3a | 4.9.3  | 2.1.2  | local superbuild
...
[Slackware](#slackware) 14.2 | 3.5.2 | gcc 5.3.0 | Qt 5.7.1 (SBo) | 6.4.2 (SBo) | 4.9.3 (SBo) | 2.2.1 (SBo) | [SlackBuilds.org](#slackware)
...
Windows                   | 3.7.1  | gcc 5.3.1  | 5.6.2  | 6.1.3a | 4.9.3  | 2.1.2  | OBS/openSUSE Leap 42.2/superbuild
...
openSUSE 13.2 :-1: | 3.0.2 :-1: | gcc 4.8.3 :-1: | 5.3.2 :-1: | 6.1.3a | 4.8.0  | -.-.-  | OBS
