...
Linux Mint 17.x (= Ubuntu 14.04) | 2.8.12 :-1: | gcc 4.8.2 :-1: | 5.2.1 :-1:  | 6.1.3a    | 4.8.0       | 1.10.1      | no build
Linux Mint 18.x (= Ubuntu 16.04) | 3.2.2      | gcc 5.2.1   | 5.5.1 :+1:  | 6.1.3a       | 4.9.2 :+1:  | 1.11.3      | no build
...
(Ubuntu 16.04) | 3.2.2      | gcc 5.2.1   | 5.5.1 :+1:  | 6.1.3a       | 4.9.2 :+1:  | 1.11.3      | no build
